...
// SMWheelControl
#define COCOAPODS_POD_AVAILABLE_SMWheelControl
#define COCOAPODS_VERSION_MAJOR_SMWheelControl 0
#define COCOAPODS_VERSION_MINOR_SMWheelControl 1
#define COCOAPODS_VERSION_PATCH_SMWheelControl 1
